...
public class BlockGenerator {
     ...
     * @param ledgerHash          Hash of the current ledger BEFORE transactions held in this block applied
     ...
     */
    public static String complieBlock(long timestamp, int blockNum, String previousBlockHash, long difficulty, int winningNonce, String ledgerHash, ArrayList<String> transactions, Certificate certificate, String signingAddress, String privateKey, long minerSignatureIndex) {
        ...
        // This String will be added to a lo.
        String block = "";
