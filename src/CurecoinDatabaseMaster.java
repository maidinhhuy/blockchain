 ...
 * account balance lookup, account tree management, blockchain storage, etc
 **/
public class CurecoinDatabaseMaster {
     ...
     * @return boolean Wheter block addition was successful
     **/
    ...
    /**
     * Gets a the block at a certian height of the longest chain; passthrough to Blockchain.getBlock(int blockNum)
     *
    ...
    /**
     * Return the block of highest chain
     **/
    ...
    /**
     * Constructor for CurecoinDatabaseMaster reads in blockchain data, and writes the first two blocks of the network
     **/
    public CurecoinDatabaseMaster(String dbFolder) {
        ...
        try {
            ...
            Scanner scanner = new Scanner(blockchainFile);
     ...
     */
    public boolean isValidNormAddress(String toTest) {
     ...
     * @return int Signautre index of address
     */
    ...
    /**
     * Increments signature index by one for the provided address; usesful when creating transactions.
     *
